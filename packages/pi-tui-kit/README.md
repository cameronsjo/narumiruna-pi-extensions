...
The detail search prefers `/` for component-local activation and falls back to `?` when an effective standard action claims `/`; hints show only the reachable shortcut.
...
The search bar prefers `/` for component-local activation and falls back to `?` when an effective standard action claims `/`; hints show only the reachable shortcut.
