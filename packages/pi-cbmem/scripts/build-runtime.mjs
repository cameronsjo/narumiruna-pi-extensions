...
const FORBIDDEN_EAGER_EXTERNALS = [];
...
export async function buildRuntime({
	...
	const stagingDirectory = await mkdtemp(join(dirname(resolvedOutputDirectory), ".pi-cbmem-dist-"));
...
async function assertSafeOutputDirectory(outputDirectory) {
	...
	const isTestOutput = firstSegment?.startsWith(".pi-cbmem-build-test-");
	if (
		relativeOutput === "" ||
		relativeOutput === ".." ||
